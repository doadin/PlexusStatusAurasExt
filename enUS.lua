...
L["Use this template if you only want to define a simple list of auras which should be shown in Plexus (e.g. a list of raid debuffs)."] = true
...
L["Colors the status by the magic type of the displayed aura. You can edit the colors under \"Plexus->Status->Colors\""] = true
